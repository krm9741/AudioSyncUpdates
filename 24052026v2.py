...
credentials = service_account.Credentials.from_service_account_file(
    "audiasync-project-050825-de67120821a2.json"
)
...
class SpeechToTextApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.splash_movie = QMovie("AudiaSyncIcon.gif")
    ...
    def init_main_ui(self):
        ...
        self.label = QLabel(
            "Press Trig To Start Service Welcome to AudioSync Pluto...!",
            self
        )
        ...
        self.image_paths = [
            'AudiaSyncIcon.png',
            'MicIcon.png',
            'MonitorDIsplayIcon.png',
            'WifiTransmittingIcon.png'
        ]
        ...
        for path in self.image_paths:
            ...
            label = QLabel()
            if path == 'WifiTransmittingIcon.png':
    ...
    def _fill_buffer(
        ...
        if rms > RMS_THRESHOLD:
            ...
            if time.time() - self.voice_detected_time > 1.5:
                ...
                new_pixmap = QPixmap("MicIcon.png")
    ...
    def on_audio_detected(self):
        ...
        new_pixmap = QPixmap("MicBlue.png")
